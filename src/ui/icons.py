...
# ES: Ancho de trazo relativo al tamaño del ícono, consistente en todo el set.
# EN: Stroke width relative to icon size, kept consistent across the whole set.
...
def icon(kind: str, color: str, size: int = 18) -> QIcon:
    ...
    dpr = 2  # ES: se dibuja a 2x para nitidez en pantallas HiDPI / EN: drawn at 2x for sharpness on HiDPI screens
