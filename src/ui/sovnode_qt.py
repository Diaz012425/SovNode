...
I18N = {
    "Español": {
        ...
        "web_search_toggle_tooltip": "Forzar búsqueda web en este turno",
    ...
    "English": {
        ...
        "web_search_toggle_tooltip": "Force web search for this turn",
...
class ModelDownloadDialog(QDialog):
    ...
    # Sugerencias de descarga, no un selector: el modelo de respuesta lo
    # fija Orchestrator.RESPONSE_MODEL (qwen2.5:7b). nomic-embed-text es el
    # de embeddings; el resto son alternativas que el usuario puede querer
    # a mano.
    COMMON_TAGS = (
        "qwen2.5:7b",
        "qwen2.5:3b",
...
class MainWindow(QMainWindow):
    ...
    def _create_ui(self) -> None:
        ...
        self.web_search_toggle_btn.setToolTip(tr["web_search_toggle_tooltip"])
    ...
    def _on_lang_changed(self, lang_name: str) -> None:
        ...
        if hasattr(self, "mic_button"):
            self.mic_button.setToolTip(tr["mic_tooltip"])
        if hasattr(self, "web_search_toggle_btn"):
            self.web_search_toggle_btn.setToolTip(tr["web_search_toggle_tooltip"])
