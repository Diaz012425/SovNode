...
class LSCInferenceEngine:
    ...
    # ES: Pesos relativos de cada categoría en la agregación final.
    # EN: Relative weight of each category in the final aggregation.
    ...
    # ES: Módulos cuya presencia (como import real dentro de código embebido
    # y parseable) se considera dependencia prohibida para este dominio.
    # EN: Modules whose presence (as a real import inside parseable embedded
    # code) counts as a forbidden dependency for this domain.
    ...
    def _evaluate_no_imports(self, premise: str) -> Tuple[float, Tuple[str, ...]]:
        ...
        try:
            ...
            # ES: Menciona palabras clave de código pero no es código parseable
            # real (p. ej. prosa sobre "importar" conceptos); se trata como prosa.
            # EN: Mentions code keywords but isn't real parseable code (e.g.
            # prose about "importing" concepts); treated as prose.
            return 1.0, ()
