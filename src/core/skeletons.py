...
SKELETONS: "dict[str, Skeleton]" = {
    "snake": {
        "key": "snake",
        "filename": "snake.py",
        # BLINDAJE (robustez del Lever 1, 2026-09-09): "serpiente" agregado
        # porque esta app se usa en español — `_resolve_modify_target`
        # (orchestrator.py) reutiliza este mismo `match` como fallback para
        # resolver el archivo a modificar cuando el usuario no menciona un
        # nombre de archivo explícito ("mejora el juego de la serpiente"),
        # y sin la palabra en español ese pedido no matcheaba nada.
        "match": re.compile(r"\b(?:snake|serpiente)\b", re.IGNORECASE),
