...
# Búsqueda de imágenes dedicada (ver `search_topic_images()` — auditoría
# de búsqueda web 2026-09-07, pedido explícito: "siempre que se active la
# búsqueda web, siempre agarre las tres imágenes relacionadas al tema").
