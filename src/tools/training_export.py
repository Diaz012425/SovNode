...
idioma equivocado — ver la verificación post-hoc consolidada en
`run_turn` / `_build_consolidated_correction_prompt`), ese evento queda
registrado en el WAL (`sovnode.wal`) como un `turn_phase` con
`phase == "correction_pair"`, junto con el texto ORIGINAL (malo) y el
